...
var sidebarToggle = document.getElementById('sidebarToggle'); // O link que contém o ícone e texto do toggle
...
// Função para expandir/recolher o menu
if (sidebarToggle) {
    sidebarToggle.addEventListener('click', function(event) {
        event.preventDefault(); // Previne o comportamento padrão do link
        sidebar.classList.toggle('expandir');

        // Altera o ícone e o texto do botão de toggle
